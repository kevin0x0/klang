...
KlrSymbol** klr_util_get_symbol_array(KlrSymbol* start, KlrSymbol** end_symbols, size_t end_symbol_no, size_t* p_size);
...
KBitSet** klr_util_compute_follows(KlrSymbol** symbols, KBitSet** firsts, size_t symbol_no, size_t terminal_no, KlrSymbol* start, KlrSymbol** end_symbols, size_t end_symbol_no);
