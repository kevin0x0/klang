...
#define KLCONFIG_LIBRARY_TRACEBACK_ENTRYFUNCNAME_QUOTE      ("kllib_traceback_init")
...
#define KLCONFIG_LIBRARY_CAST_ENTRYFUNCNAME_QUOTE           ("kllib_cast_init")
#define KLCONFIG_LIBRARY_OS_ENTRYFUNCNAME_QUOTE             ("kllib_os_init")
