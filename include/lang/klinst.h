...
#define KLOPCODE_APPEND             (40)
#define KLOPCODE_MKCLASS            (41)
#define KLOPCODE_INDEXI             (42)
#define KLOPCODE_INDEXASI           (43)
#define KLOPCODE_INDEX              (44)
#define KLOPCODE_INDEXAS            (45)
#define KLOPCODE_GETFIELDR          (46)
#define KLOPCODE_GETFIELDC          (47)
#define KLOPCODE_SETFIELDR          (48)
#define KLOPCODE_SETFIELDC          (49)
#define KLOPCODE_REFGETFIELDR       (50)
#define KLOPCODE_REFGETFIELDC       (51)
#define KLOPCODE_REFSETFIELDR       (52)
#define KLOPCODE_REFSETFIELDC       (53)
#define KLOPCODE_NEWLOCAL           (54)
#define KLOPCODE_NEWMETHODC         (55)
#define KLOPCODE_NEWMETHODR         (56)
#define KLOPCODE_LOADFALSESKIP      (57)
#define KLOPCODE_TESTSET            (58)
#define KLOPCODE_TRUEJMP            (59)
#define KLOPCODE_FALSEJMP           (60)
#define KLOPCODE_JMP                (61)
#define KLOPCODE_CONDJMP            (62)
#define KLOPCODE_CLOSEJMP           (63)
#define KLOPCODE_HASFIELD           (64)
#define KLOPCODE_IS                 (65)
#define KLOPCODE_EQ                 (66)
#define KLOPCODE_NE                 (67)
#define KLOPCODE_LE                 (68)
#define KLOPCODE_GE                 (69)
#define KLOPCODE_LT                 (70)
#define KLOPCODE_GT                 (71)
#define KLOPCODE_EQC                (72)
#define KLOPCODE_NEC                (73)
#define KLOPCODE_LEC                (74)
#define KLOPCODE_GEC                (75)
#define KLOPCODE_LTC                (76)
#define KLOPCODE_GTC                (77)
#define KLOPCODE_EQI                (78)
#define KLOPCODE_NEI                (79)
#define KLOPCODE_LEI                (80)
#define KLOPCODE_GEI                (81)
#define KLOPCODE_LTI                (82)
#define KLOPCODE_GTI                (83)
#define KLOPCODE_MATCH              (84)
#define KLOPCODE_PBARR              (85)
#define KLOPCODE_PBTUP              (86)
#define KLOPCODE_PBMAP              (87)
#define KLOPCODE_PBOBJ              (88)
#define KLOPCODE_PMARR              (89)
#define KLOPCODE_PMTUP              (90)
#define KLOPCODE_PMMAP              (91)
#define KLOPCODE_PMOBJ              (92)
#define KLOPCODE_PMAPPOST           (93)
#define KLOPCODE_NEWOBJ             (94)
#define KLOPCODE_ADJUSTARGS         (95)
#define KLOPCODE_VFORPREP           (96)
#define KLOPCODE_VFORLOOP           (97)
#define KLOPCODE_IFORPREP           (98)
#define KLOPCODE_IFORLOOP           (99)
#define KLOPCODE_GFORLOOP           (100)
#define KLOPCODE_ASYNC              (101)
#define KLOPCODE_YIELD              (102)
#define KLOPCODE_VARARG             (103)
#define KLOPCODE_NINST              (104)
