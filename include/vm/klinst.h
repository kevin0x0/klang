...
#define KLOPCODE_SCALL              (22)
#define KLOPCODE_CALL               (23)
#define KLOPCODE_METHOD             (24)
#define KLOPCODE_RETURN             (25)
#define KLOPCODE_RETURN0            (26)
#define KLOPCODE_RETURN1            (27)
#define KLOPCODE_LOADBOOL           (28)
#define KLOPCODE_LOADI              (29)
#define KLOPCODE_LOADC              (30)
#define KLOPCODE_LOADNIL            (31)
#define KLOPCODE_LOADREF            (32)
#define KLOPCODE_LOADGLOBAL         (33)
#define KLOPCODE_STOREREF           (34)
#define KLOPCODE_STOREGLOBAL        (35)
#define KLOPCODE_MKMAP              (36)
#define KLOPCODE_MKARRAY            (37)
#define KLOPCODE_MKCLOSURE          (38)
#define KLOPCODE_MKMETHOD           (39)
...
#define KLOPCODE_LOADFALSESKIP      (55)
#define KLOPCODE_TESTSET            (56)
#define KLOPCODE_TRUEJMP            (57)
#define KLOPCODE_FALSEJMP           (58)
#define KLOPCODE_JMP                (59)
#define KLOPCODE_CONDJMP            (60)
#define KLOPCODE_CLOSEJMP           (61)
#define KLOPCODE_HASFIELD           (62)
#define KLOPCODE_IS                 (63)
#define KLOPCODE_EQ                 (64)
#define KLOPCODE_NE                 (65)
#define KLOPCODE_LE                 (66)
#define KLOPCODE_GE                 (67)
#define KLOPCODE_LT                 (68)
#define KLOPCODE_GT                 (69)
#define KLOPCODE_EQC                (70)
#define KLOPCODE_NEC                (71)
#define KLOPCODE_LEC                (72)
#define KLOPCODE_GEC                (73)
#define KLOPCODE_LTC                (74)
#define KLOPCODE_GTC                (75)
#define KLOPCODE_EQI                (76)
#define KLOPCODE_NEI                (77)
#define KLOPCODE_LEI                (78)
#define KLOPCODE_GEI                (79)
#define KLOPCODE_LTI                (80)
#define KLOPCODE_GTI                (81)
#define KLOPCODE_MATCH              (82)
#define KLOPCODE_PBARR              (83)
#define KLOPCODE_PBTUP              (84)
#define KLOPCODE_PBMAP              (85)
#define KLOPCODE_PBOBJ              (86)
#define KLOPCODE_PMARR              (87)
#define KLOPCODE_PMTUP              (88)
#define KLOPCODE_PMMAP              (89)
#define KLOPCODE_PMOBJ              (90)
#define KLOPCODE_PMAPPOST           (91)
#define KLOPCODE_NEWOBJ             (92)
#define KLOPCODE_ADJUSTARGS         (93)
#define KLOPCODE_VFORPREP           (94)
#define KLOPCODE_VFORLOOP           (95)
#define KLOPCODE_IFORPREP           (96)
#define KLOPCODE_IFORLOOP           (97)
