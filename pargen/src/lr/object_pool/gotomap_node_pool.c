...
inline KevGotoMapNode* kev_gotomap_node_pool_acquire(void) {
  return (KevGotoMapNode*)malloc(sizeof (union KevGotoMapNodePool));
}

inline KevGotoMapNode* kev_gotomap_node_pool_allocate(void) {
...
inline void kev_gotomap_node_pool_deallocate(KevGotoMapNode* gotomap_node) {
  if (gotomap_node) {
