...
static ActionEntry action_tbl[18][8] = {
  ...
  {
    { 0,   -1 }, { 1,   10 }, { 1,   11 }, { 1,    9 }, { 1,   12 }, { 0,   -1 }, { 0,   -1 }, { 3,   -1 }, 
  },
  {
  ...
  {
    { 0,   -1 }, { 1,   10 }, { 1,   11 }, { 1,    9 }, { 1,   12 }, { 0,   -1 }, { 1,   13 }, { 0,   -1 }, 
  },
  {
    { 1,    4 }, { 1,    1 }, { 1,    2 }, { 0,   -1 }, { 0,   -1 }, { 1,    3 }, { 0,   -1 }, { 0,   -1 }, 
  },
  ...
  {
    { 0,   -1 }, { 2,    0 }, { 2,    0 }, { 1,    9 }, { 1,   12 }, { 0,   -1 }, { 2,    0 }, { 2,    0 }, 
  },
  {
    { 0,   -1 }, { 2,    1 }, { 2,    1 }, { 1,    9 }, { 1,   12 }, { 0,   -1 }, { 2,    1 }, { 2,    1 }, 
  },
  {
...
static int16_t goto_tbl[18][9] = {
  {
      ...
      -1,  10,  11,   9,  12,  -1,  -1,  -1,  -1,
  }, {
      -1,  10,  11,   9,  12,  -1,  -1,  -1,  -1,
  }, {
      -1,  10,  11,   9,  12,  -1,  -1,  -1,  -1,
  }, {
      -1,  10,  11,   9,  12,  -1,  13,  -1,  -1,
  }, {
       4,   1,   2,  -1,  -1,   3,  -1,  -1,  14,
  }, {
       4,   1,   2,  -1,  -1,   3,  -1,  -1,  15,
...
static int state_symbol_mapping[18] = {
    -1,   1,   2,   5,   0,   8,   8,   8,   8,   3,   1,   2,   4,   6,   8,   8,
     8,   8,
};
