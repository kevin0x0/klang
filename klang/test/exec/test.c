...
void fibonacci(KlState* state) {
  ...
  code[1] = klinst_condjmp(true, 8);
  code[2] = klinst_loadref(1, 0);
  code[3] = klinst_subi(2, 0, 1);
  code[4] = klinst_call(1, 1, 1);
  code[5] = klinst_loadref(2, 0);
  code[6] = klinst_subi(3, 0, 2);
  code[7] = klinst_call(2, 1, 1);
  code[8] = klinst_add(1, 1, 2);
  code[9] = klinst_jmp(1);
  code[10] = klinst_move(1, 0);
