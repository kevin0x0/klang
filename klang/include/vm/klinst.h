...
#define KLOPCODE_TRUEJMP            (48)
#define KLOPCODE_FALSEJMP           (49)
#define KLOPCODE_JMP                (50)
#define KLOPCODE_CONDJMP            (51)
#define KLOPCODE_EQ                 (52)
#define KLOPCODE_NE                 (53)
#define KLOPCODE_LE                 (54)
#define KLOPCODE_GE                 (55)
#define KLOPCODE_LT                 (56)
#define KLOPCODE_GT                 (57)
#define KLOPCODE_EQC                (58)
#define KLOPCODE_NEC                (59)
#define KLOPCODE_LEC                (60)
#define KLOPCODE_GEC                (61)
#define KLOPCODE_LTC                (62)
#define KLOPCODE_GTC                (63)
#define KLOPCODE_EQI                (64)
#define KLOPCODE_NEI                (65)
#define KLOPCODE_LEI                (66)
#define KLOPCODE_GEI                (67)
#define KLOPCODE_LTI                (68)
#define KLOPCODE_GTI                (69)
#define KLOPCODE_CLOSE              (70)
#define KLOPCODE_NEWOBJ             (71)
#define KLOPCODE_ADJUSTARGS         (72)
#define KLOPCODE_VFORPREP           (73)
#define KLOPCODE_VFORLOOP           (74)
#define KLOPCODE_IFORPREP           (75)
#define KLOPCODE_IFORLOOP           (76)
#define KLOPCODE_GFORLOOP           (77)
#define KLOPCODE_ASYNC              (78)
#define KLOPCODE_YIELD              (79)
