...
#define KLOPCODE_IDIV               (6)
#define KLOPCODE_CONCAT             (7)
#define KLOPCODE_ADDI               (8)
#define KLOPCODE_SUBI               (9)
#define KLOPCODE_MULI               (10)
#define KLOPCODE_MODI               (11)
#define KLOPCODE_IDIVI              (12)
#define KLOPCODE_ADDC               (13)
#define KLOPCODE_SUBC               (14)
#define KLOPCODE_MULC               (15)
#define KLOPCODE_DIVC               (16)
#define KLOPCODE_MODC               (17)
#define KLOPCODE_IDIVC              (18)
#define KLOPCODE_NEG                (19)
#define KLOPCODE_CALL               (20)
#define KLOPCODE_METHOD             (21)
#define KLOPCODE_RETURN             (22)
#define KLOPCODE_RETURN0            (23)
#define KLOPCODE_RETURN1            (24)
#define KLOPCODE_LOADBOOL           (25)
#define KLOPCODE_LOADI              (26)
#define KLOPCODE_LOADC              (27)
#define KLOPCODE_LOADNIL            (28)
#define KLOPCODE_LOADREF            (29)
#define KLOPCODE_LOADGLOBAL         (30)
#define KLOPCODE_STOREREF           (31)
#define KLOPCODE_STOREGLOBAL        (32)
#define KLOPCODE_MKMAP              (33)
#define KLOPCODE_MKARRAY            (34)
#define KLOPCODE_APPEND             (35)
#define KLOPCODE_MKCLASS            (36)
#define KLOPCODE_INDEXI             (37)
#define KLOPCODE_INDEXASI           (38)
#define KLOPCODE_INDEX              (39)
#define KLOPCODE_INDEXAS            (40)
#define KLOPCODE_GETFIELDR          (41)
#define KLOPCODE_GETFIELDC          (42)
#define KLOPCODE_SETFIELDR          (43)
#define KLOPCODE_SETFIELDC          (44)
#define KLOPCODE_REFGETFIELDR       (45)
#define KLOPCODE_REFGETFIELDC       (46)
#define KLOPCODE_REFSETFIELDR       (47)
#define KLOPCODE_REFSETFIELDC       (48)
#define KLOPCODE_NEWLOCAL           (49)
#define KLOPCODE_LOADFALSESKIP      (50)
#define KLOPCODE_TESTSET            (51)
#define KLOPCODE_TRUEJMP            (52)
#define KLOPCODE_FALSEJMP           (53)
#define KLOPCODE_JMP                (54)
#define KLOPCODE_CONDJMP            (55)
#define KLOPCODE_CLOSEJMP           (56)
#define KLOPCODE_IS                 (57)
#define KLOPCODE_EQ                 (58)
#define KLOPCODE_NE                 (59)
#define KLOPCODE_LE                 (60)
#define KLOPCODE_GE                 (61)
#define KLOPCODE_LT                 (62)
#define KLOPCODE_GT                 (63)
#define KLOPCODE_EQC                (64)
#define KLOPCODE_NEC                (65)
#define KLOPCODE_LEC                (66)
#define KLOPCODE_GEC                (67)
#define KLOPCODE_LTC                (68)
#define KLOPCODE_GTC                (69)
#define KLOPCODE_EQI                (70)
#define KLOPCODE_NEI                (71)
#define KLOPCODE_LEI                (72)
#define KLOPCODE_GEI                (73)
#define KLOPCODE_LTI                (74)
#define KLOPCODE_GTI                (75)
#define KLOPCODE_NEWOBJ             (76)
#define KLOPCODE_ADJUSTARGS         (77)
#define KLOPCODE_VFORPREP           (78)
#define KLOPCODE_VFORLOOP           (79)
#define KLOPCODE_IFORPREP           (80)
#define KLOPCODE_IFORLOOP           (81)
#define KLOPCODE_GFORLOOP           (82)
#define KLOPCODE_ASYNC              (83)
#define KLOPCODE_YIELD              (84)
