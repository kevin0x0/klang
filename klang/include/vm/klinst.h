...
#define KLOPCODE_MKCLASS            (35)
#define KLOPCODE_INDEX              (36)
#define KLOPCODE_INDEXAS            (37)
#define KLOPCODE_GETFIELDR          (38)
#define KLOPCODE_GETFIELDC          (39)
#define KLOPCODE_SETFIELDR          (40)
#define KLOPCODE_SETFIELDC          (41)
#define KLOPCODE_REFGETFIELDR       (42)
#define KLOPCODE_REFGETFIELDC       (43)
#define KLOPCODE_REFSETFIELDR       (44)
#define KLOPCODE_REFSETFIELDC       (45)
#define KLOPCODE_THISGETFIELD       (46)
#define KLOPCODE_THISSETFIELD       (47)
#define KLOPCODE_NEWLOCAL           (48)
#define KLOPCODE_JMP                (49)
#define KLOPCODE_BE                 (50)
#define KLOPCODE_BNE                (51)
#define KLOPCODE_BLE                (52)
#define KLOPCODE_BGE                (53)
#define KLOPCODE_BL                 (54)
#define KLOPCODE_BG                 (55)
#define KLOPCODE_BEC                (56)
#define KLOPCODE_BNEC               (57)
#define KLOPCODE_BLEC               (58)
#define KLOPCODE_BGEC               (59)
#define KLOPCODE_BLC                (60)
#define KLOPCODE_BGC                (61)
#define KLOPCODE_BEI                (62)
#define KLOPCODE_BNEI               (63)
#define KLOPCODE_BLEI               (64)
#define KLOPCODE_BGEI               (65)
#define KLOPCODE_BLI                (66)
#define KLOPCODE_BGI                (67)
#define KLOPCODE_NBE                (68)
#define KLOPCODE_NBNE               (69)
#define KLOPCODE_NBLE               (70)
#define KLOPCODE_NBGE               (71)
#define KLOPCODE_NBL                (72)
#define KLOPCODE_NBG                (73)
#define KLOPCODE_NBLEC              (74)
#define KLOPCODE_NBGEC              (75)
#define KLOPCODE_NBLC               (76)
#define KLOPCODE_NBGC               (77)
#define KLOPCODE_NBLEI              (78)
#define KLOPCODE_NBGEI              (79)
#define KLOPCODE_NBLI               (80)
#define KLOPCODE_NBGI               (81)
#define KLOPCODE_CLOSE              (82)
#define KLOPCODE_NEWOBJ             (83)
#define KLOPCODE_ADJUSTARGS         (84)
#define KLOPCODE_VFORPREP           (85)
#define KLOPCODE_VFORLOOP           (86)
#define KLOPCODE_IFORPREP           (87)
#define KLOPCODE_IFORLOOP           (88)
#define KLOPCODE_GFORLOOP           (89)
#define KLOPCODE_ASYNC              (90)
#define KLOPCODE_YIELD              (91)
