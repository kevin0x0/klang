...
#define KLOPCODE_TRUEJMP            (50)
#define KLOPCODE_FALSEJMP           (51)
#define KLOPCODE_JMP                (52)
#define KLOPCODE_CONDJMP            (53)
#define KLOPCODE_EQ                 (54)
#define KLOPCODE_NE                 (55)
#define KLOPCODE_LE                 (56)
#define KLOPCODE_GE                 (57)
#define KLOPCODE_LT                 (58)
#define KLOPCODE_GT                 (59)
#define KLOPCODE_EQC                (60)
#define KLOPCODE_NEC                (61)
#define KLOPCODE_LEC                (62)
#define KLOPCODE_GEC                (63)
#define KLOPCODE_LTC                (64)
#define KLOPCODE_GTC                (65)
#define KLOPCODE_EQI                (66)
#define KLOPCODE_NEI                (67)
#define KLOPCODE_LEI                (68)
#define KLOPCODE_GEI                (69)
#define KLOPCODE_LTI                (70)
#define KLOPCODE_GTI                (71)
#define KLOPCODE_CLOSE              (72)
#define KLOPCODE_NEWOBJ             (73)
#define KLOPCODE_ADJUSTARGS         (74)
#define KLOPCODE_VFORPREP           (75)
#define KLOPCODE_VFORLOOP           (76)
#define KLOPCODE_IFORPREP           (77)
#define KLOPCODE_IFORLOOP           (78)
#define KLOPCODE_GFORLOOP           (79)
#define KLOPCODE_ASYNC              (80)
#define KLOPCODE_YIELD              (81)
...
#define klinst_eq(a, b)                                   klinst_AB(KLOPCODE_EQ, (a), (b))
#define klinst_ne(a, b)                                   klinst_AB(KLOPCODE_NE, (a), (b))
#define klinst_le(a, b)                                   klinst_AB(KLOPCODE_LE, (a), (b))
#define klinst_ge(a, b)                                   klinst_AB(KLOPCODE_GE, (a), (b))
#define klinst_lt(a, b)                                   klinst_AB(KLOPCODE_LT, (a), (b))
#define klinst_gt(a, b)                                   klinst_AB(KLOPCODE_GT, (a), (b))
