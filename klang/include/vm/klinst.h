...
#define KLOPCODE_APPEND             (33)
#define KLOPCODE_MKCLASS            (34)
#define KLOPCODE_INDEXI             (35)
#define KLOPCODE_INDEXASI           (36)
...
#define KLOPCODE_NEWLOCAL           (47)
#define KLOPCODE_LOADFALSESKIP      (48)
#define KLOPCODE_TESTSET            (49)
...
#define klinst_indexi(a, indexable, index)                klinst_ABI(KLOPCODE_INDEXI, (a), (indexable), (index))
#define klinst_indexasi(val, indexable, index)            klinst_ABI(KLOPCODE_INDEXASI, (val), (indexable), (index))
