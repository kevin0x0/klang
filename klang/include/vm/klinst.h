...
#define KLOPCODE_HASFIELD           (60)
#define KLOPCODE_IS                 (61)
#define KLOPCODE_EQ                 (62)
#define KLOPCODE_NE                 (63)
#define KLOPCODE_LE                 (64)
#define KLOPCODE_GE                 (65)
#define KLOPCODE_LT                 (66)
#define KLOPCODE_GT                 (67)
#define KLOPCODE_EQC                (68)
#define KLOPCODE_NEC                (69)
#define KLOPCODE_LEC                (70)
#define KLOPCODE_GEC                (71)
#define KLOPCODE_LTC                (72)
#define KLOPCODE_GTC                (73)
#define KLOPCODE_EQI                (74)
#define KLOPCODE_NEI                (75)
#define KLOPCODE_LEI                (76)
#define KLOPCODE_GEI                (77)
#define KLOPCODE_LTI                (78)
#define KLOPCODE_GTI                (79)
#define KLOPCODE_MATCH              (80)
#define KLOPCODE_PBARR              (81)
#define KLOPCODE_PBTUP              (82)
#define KLOPCODE_PBMAP              (83)
#define KLOPCODE_PBOBJ              (84)
#define KLOPCODE_PMARR              (85)
#define KLOPCODE_PMTUP              (86)
#define KLOPCODE_PMMAP              (87)
#define KLOPCODE_PMOBJ              (88)
#define KLOPCODE_PMAPPOST           (89)
#define KLOPCODE_NEWOBJ             (90)
#define KLOPCODE_ADJUSTARGS         (91)
#define KLOPCODE_VFORPREP           (92)
#define KLOPCODE_VFORLOOP           (93)
#define KLOPCODE_IFORPREP           (94)
#define KLOPCODE_IFORLOOP           (95)
#define KLOPCODE_GFORLOOP           (96)
#define KLOPCODE_ASYNC              (97)
#define KLOPCODE_YIELD              (98)
