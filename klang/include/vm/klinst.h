...
#define KLOPCODE_IS                 (56)
#define KLOPCODE_EQ                 (57)
#define KLOPCODE_NE                 (58)
#define KLOPCODE_LE                 (59)
#define KLOPCODE_GE                 (60)
#define KLOPCODE_LT                 (61)
#define KLOPCODE_GT                 (62)
#define KLOPCODE_EQC                (63)
#define KLOPCODE_NEC                (64)
#define KLOPCODE_LEC                (65)
#define KLOPCODE_GEC                (66)
#define KLOPCODE_LTC                (67)
#define KLOPCODE_GTC                (68)
#define KLOPCODE_EQI                (69)
#define KLOPCODE_NEI                (70)
#define KLOPCODE_LEI                (71)
#define KLOPCODE_GEI                (72)
#define KLOPCODE_LTI                (73)
#define KLOPCODE_GTI                (74)
#define KLOPCODE_CLOSE              (75)
