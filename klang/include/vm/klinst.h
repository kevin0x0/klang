...
#define KLOPCODE_CALL               (21)
#define KLOPCODE_METHOD             (22)
#define KLOPCODE_RETURN             (23)
#define KLOPCODE_RETURN0            (24)
#define KLOPCODE_RETURN1            (25)
#define KLOPCODE_LOADBOOL           (26)
#define KLOPCODE_LOADI              (27)
#define KLOPCODE_LOADC              (28)
#define KLOPCODE_LOADNIL            (29)
#define KLOPCODE_LOADREF            (30)
#define KLOPCODE_LOADGLOBAL         (31)
#define KLOPCODE_STOREREF           (32)
#define KLOPCODE_STOREGLOBAL        (33)
#define KLOPCODE_MKMAP              (34)
#define KLOPCODE_MKARRAY            (35)
#define KLOPCODE_MKCLOSURE          (36)
#define KLOPCODE_MKMETHOD           (37)
#define KLOPCODE_APPEND             (38)
#define KLOPCODE_MKCLASS            (39)
#define KLOPCODE_INDEXI             (40)
#define KLOPCODE_INDEXASI           (41)
#define KLOPCODE_INDEX              (42)
#define KLOPCODE_INDEXAS            (43)
#define KLOPCODE_GETFIELDR          (44)
#define KLOPCODE_GETFIELDC          (45)
#define KLOPCODE_SETFIELDR          (46)
#define KLOPCODE_SETFIELDC          (47)
#define KLOPCODE_REFGETFIELDR       (48)
#define KLOPCODE_REFGETFIELDC       (49)
#define KLOPCODE_REFSETFIELDR       (50)
#define KLOPCODE_REFSETFIELDC       (51)
#define KLOPCODE_NEWLOCAL           (52)
#define KLOPCODE_LOADFALSESKIP      (53)
#define KLOPCODE_TESTSET            (54)
#define KLOPCODE_TRUEJMP            (55)
#define KLOPCODE_FALSEJMP           (56)
#define KLOPCODE_JMP                (57)
#define KLOPCODE_CONDJMP            (58)
#define KLOPCODE_CLOSEJMP           (59)
#define KLOPCODE_IS                 (60)
#define KLOPCODE_EQ                 (61)
#define KLOPCODE_NE                 (62)
#define KLOPCODE_LE                 (63)
#define KLOPCODE_GE                 (64)
#define KLOPCODE_LT                 (65)
#define KLOPCODE_GT                 (66)
#define KLOPCODE_EQC                (67)
#define KLOPCODE_NEC                (68)
#define KLOPCODE_LEC                (69)
#define KLOPCODE_GEC                (70)
#define KLOPCODE_LTC                (71)
#define KLOPCODE_GTC                (72)
#define KLOPCODE_EQI                (73)
#define KLOPCODE_NEI                (74)
#define KLOPCODE_LEI                (75)
#define KLOPCODE_GEI                (76)
#define KLOPCODE_LTI                (77)
#define KLOPCODE_GTI                (78)
#define KLOPCODE_PBARR              (79)
#define KLOPCODE_PBTUP              (80)
#define KLOPCODE_PBMAP              (81)
#define KLOPCODE_PBOBJ              (82)
#define KLOPCODE_PMARR              (83)
#define KLOPCODE_PMTUP              (84)
#define KLOPCODE_PMMAP              (85)
#define KLOPCODE_PMOBJ              (86)
#define KLOPCODE_PMAPPOST           (87)
#define KLOPCODE_NEWOBJ             (88)
#define KLOPCODE_ADJUSTARGS         (89)
#define KLOPCODE_VFORPREP           (90)
#define KLOPCODE_VFORLOOP           (91)
#define KLOPCODE_IFORPREP           (92)
#define KLOPCODE_IFORLOOP           (93)
#define KLOPCODE_GFORLOOP           (94)
#define KLOPCODE_ASYNC              (95)
#define KLOPCODE_YIELD              (96)
...
#define klinst_pbobj(a, b, nwanted)                       klinst_ABX(KLOPCODE_PBOBJ, (a), (b), (nfront))
...
#define klinst_pmobj(a, b, nwanted)                       klinst_ABX(KLOPCODE_PMOBJ, (a), (b), (nfront))
