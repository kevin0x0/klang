...
static void klcst_stmtblock_delete(KlCstStmtBlock* stmtblock);
...
static KlCstVirtualFunc klcst_stmtlet_vfunc = { .astdelete = (KlCstDelete)klcst_stmtlet_delete };
static KlCstVirtualFunc klcst_stmtassign_vfunc = { .astdelete = (KlCstDelete)klcst_stmtassign_delete };
static KlCstVirtualFunc klcst_stmtexpr_vfunc = { .astdelete = (KlCstDelete)klcst_stmtexpr_delete };
static KlCstVirtualFunc klcst_stmtif_vfunc = { .astdelete = (KlCstDelete)klcst_stmtif_delete };
static KlCstVirtualFunc klcst_stmtvfor_vfunc = { .astdelete = (KlCstDelete)klcst_stmtvfor_delete };
static KlCstVirtualFunc klcst_stmtifor_vfunc = { .astdelete = (KlCstDelete)klcst_stmtifor_delete };
static KlCstVirtualFunc klcst_stmtgfor_vfunc = { .astdelete = (KlCstDelete)klcst_stmtgfor_delete };
static KlCstVirtualFunc klcst_stmtcfor_vfunc = { .astdelete = (KlCstDelete)klcst_stmtcfor_delete };
static KlCstVirtualFunc klcst_stmtwhile_vfunc = { .astdelete = (KlCstDelete)klcst_stmtwhile_delete };
static KlCstVirtualFunc klcst_stmtblock_vfunc = { .astdelete = (KlCstDelete)klcst_stmtblock_delete };
static KlCstVirtualFunc klcst_stmtrepeat_vfunc = { .astdelete = (KlCstDelete)klcst_stmtrepeat_delete };
static KlCstVirtualFunc klcst_stmtreturn_vfunc = { .astdelete = (KlCstDelete)klcst_stmtreturn_delete };
static KlCstVirtualFunc klcst_stmtbreak_vfunc = { .astdelete = (KlCstDelete)klcst_stmtbreak_delete };
static KlCstVirtualFunc klcst_stmtcontinue_vfunc = { .astdelete = (KlCstDelete)klcst_stmtcontinue_delete };
...
KlCstStmtIf* klcst_stmtif_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtif), KLCST_STMT_ASSIGN, &klcst_stmtif_vfunc);
  return stmtif;
}
...
KlCstStmtVFor* klcst_stmtvfor_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtvfor), KLCST_STMT_ASSIGN, &klcst_stmtvfor_vfunc);
  return stmtvfor;
}
...
KlCstStmtIFor* klcst_stmtifor_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtifor), KLCST_STMT_ASSIGN, &klcst_stmtifor_vfunc);
  return stmtifor;
}
...
KlCstStmtGFor* klcst_stmtgfor_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtgfor), KLCST_STMT_ASSIGN, &klcst_stmtgfor_vfunc);
  return stmtgfor;
}
...
KlCstStmtCFor* klcst_stmtcfor_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtcfor), KLCST_STMT_ASSIGN, &klcst_stmtcfor_vfunc);
  return stmtcfor;
}
...
KlCstStmtWhile* klcst_stmtwhile_create(void) {
  ...
  klcst_init(klcast(KlCst*, stmtwhile), KLCST_STMT_ASSIGN, &klcst_stmtwhile_vfunc);
  return stmtwhile;
}

KlCstStmtBlock* klcst_stmtblock_create(void) {
  KlCstStmtBlock* stmtblock = (KlCstStmtBlock*)malloc(sizeof (KlCstStmtBlock));
  if (kl_unlikely(!stmtblock)) return NULL;
  klcst_init(klcast(KlCst*, stmtblock), KLCST_STMT_ASSIGN, &klcst_stmtblock_vfunc);
  return stmtblock;
}
