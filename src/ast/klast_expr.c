...
static KlAstInfo klast_id_vfunc = { .destructor = (KlAstDelete)klast_id_destroy, .kind = KLCST_EXPR_ID };
static KlAstInfo klast_map_vfunc = { .destructor = (KlAstDelete)klast_map_destroy, .kind = KLCST_EXPR_MAP };
static KlAstInfo klast_array_vfunc = { .destructor = (KlAstDelete)klast_array_destroy, .kind = KLCST_EXPR_ARR };
static KlAstInfo klast_arraygenerator_vfunc = { .destructor = (KlAstDelete)klast_arraygenerator_destroy, .kind = KLCST_EXPR_ARRGEN };
static KlAstInfo klast_class_vfunc = { .destructor = (KlAstDelete)klast_class_destroy, .kind = KLCST_EXPR_CLASS };
static KlAstInfo klast_constant_vfunc = { .destructor = (KlAstDelete)klast_constant_destroy, .kind = KLCST_EXPR_CONSTANT };
static KlAstInfo klast_vararg_vfunc = { .destructor = (KlAstDelete)klast_vararg_destroy, .kind = KLCST_EXPR_VARARG };
static KlAstInfo klast_tuple_vfunc = { .destructor = (KlAstDelete)klast_tuple_destroy, .kind = KLCST_EXPR_TUPLE };
static KlAstInfo klast_bin_vfunc = { .destructor = (KlAstDelete)klast_bin_destroy, .kind = KLCST_EXPR_BIN };
static KlAstInfo klast_pre_vfunc = { .destructor = (KlAstDelete)klast_pre_destroy, .kind = KLCST_EXPR_PRE };
static KlAstInfo klast_new_vfunc = { .destructor = (KlAstDelete)klast_new_destroy, .kind = KLCST_EXPR_NEW };
static KlAstInfo klast_yield_vfunc = { .destructor = (KlAstDelete)klast_yield_destroy, .kind = KLCST_EXPR_YIELD };
static KlAstInfo klast_post_vfunc = { .destructor = (KlAstDelete)klast_post_destroy, .kind = KLCST_EXPR_POST };
static KlAstInfo klast_call_vfunc = { .destructor = (KlAstDelete)klast_call_destroy, .kind = KLCST_EXPR_CALL };
static KlAstInfo klast_dot_vfunc = { .destructor = (KlAstDelete)klast_dot_destroy, .kind = KLCST_EXPR_DOT };
static KlAstInfo klast_func_vfunc = { .destructor = (KlAstDelete)klast_func_destroy, .kind = KLCST_EXPR_FUNC };
static KlAstInfo klast_where_vfunc = { .destructor = (KlAstDelete)klast_where_destroy, .kind = KLCST_EXPR_WHERE };
